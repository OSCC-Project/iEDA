...
TclInitRT::TclInitRT(const char* cmd_name) : TclCmd(cmd_name)
{
  ...
  _config_list.push_back(std::make_pair("-enable_idrc_interface", ValueType::kInt));
  ...
  _config_list.push_back(std::make_pair("-ta_blockage_unit", ValueType::kDouble));
  // double ta_net_shape_unit;              // optional
  _config_list.push_back(std::make_pair("-ta_net_shape_unit", ValueType::kDouble));
  ...
  _config_list.push_back(std::make_pair("-dr_blockage_unit", ValueType::kDouble));
  // double dr_net_shape_unit;              // optional
  _config_list.push_back(std::make_pair("-dr_net_shape_unit", ValueType::kDouble));
