...
namespace idb {
  ...
  void TreeNode::SetParent(TreeNode &node) { _parent = &node; }
  ...
  Tree ::Tree(const int type) { _nodes.push_back(new TreeNode(type)); }
  ...
  bool Tree ::IsEmpty() const { return _nodes.empty(); }

  int Tree ::Size() const { return (int)_nodes.size(); }
  ...
  Iterator Tree ::begin() { return Iterator(this, _nodes.begin()); }

  Iterator Tree ::end() { return Iterator(this, _nodes.end()); }
  int Tree ::Root() const { return (*_nodes.begin())->_data; }
  ...
  bool Iterator ::operator==(const Iterator &it) { return _tree == it._tree && _lit == it._lit; }
  ...
  int Iterator ::operator*() const { return ((*_lit)->_data); }

  bool Iterator ::operator!() { return _lit == _tree->_nodes.end(); }
