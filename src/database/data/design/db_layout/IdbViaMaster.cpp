...
namespace idb {
  ...
  void IdbViaMasterRulePattern::parse_pattern_row_value(size_t row_index, string value) {
    if (row_index >= _pattern_state.size()) {
      std::cout << "Error : pattern index error, pattern size = " << _pattern_state.size() << " row index = " << row_index
                << std::endl;
      return;
    }
   ...
   * @return int
   */
  int IdbViaMasterRulePattern::hexString2Int(string hex_string) { return std::stoi(hex_string, nullptr, 16); }
  /**
  ...
  int8_t IdbViaMasterRulePattern::getBitVaule(int8_t& value, int32_t index) {
    int8_t bit_value = 0;
    switch (index) {
      case 0: bit_value = value & 0x01; break;
      case 1: bit_value = (value & 0x02) >> 1; break;
      case 2: bit_value = (value & 0x04) >> 2; break;
      case 3: bit_value = (value & 0x08) >> 3; break;
  ...
  IdbViaMasterGenerate::~IdbViaMasterGenerate() { clear(); }
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  IdbViaMasterFixed::IdbViaMasterFixed() { _layer_shape = new IdbLayerShape(); }

  IdbViaMasterFixed::~IdbViaMasterFixed() { clear(); }
  ...
  IdbViaMaster::~IdbViaMaster() { clear(); }
  ...
  void IdbViaMaster::set_top_layer_shape() { set_layer_shape(IdbViaLayerIndex::kLayerTop); }

  void IdbViaMaster::set_cut_layer_shape() { set_layer_shape(IdbViaLayerIndex::kLayerCut); }

  void IdbViaMaster::set_bottom_layer_shape() { set_layer_shape(IdbViaLayerIndex::kLayerBottom); }
  ...
  IdbViaMasterList::IdbViaMasterList() { _num_master = 0; }
