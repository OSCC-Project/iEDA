...
namespace idb {
  ...
  void IdbSpecialNet::add_io_pin(IdbPin* io_pin) { _io_pin_list->add_pin_list(io_pin); }

  void IdbSpecialNet::add_instance_pin(IdbPin* inst_pin) { _instance_pin_list->add_pin_list(inst_pin); }

  void IdbSpecialNet::add_instance(IdbInstance* instance) { _instance_list->add_instance(instance); }
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  IdbSpecialNetList::IdbSpecialNetList() { _num = 0; }
