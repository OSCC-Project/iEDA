...
BOOST_FUSION_ADAPT_STRUCT(
    idb::cutlayer_property::lef58_cutclass,
    (std::string, _classname)
    (double, _via_width)
    (std::optional<double>, _via_length)
    (std::optional<int>, _num_cut)
...
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_enclosure,
  (std::string, _classname)
  (std::string, _direction)
  (std::optional<double>, _overhang1)
  (std::optional<double>, _overhang2)
...
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_enclosureedge_width,
  (double, _min_width)
  (double, _par_length)
  (double, _par_within)
  (std::string, _except_extracut)
...
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_enclosureedge_convexcorners,
  (double, _convex_length)
  (double, _adjacent_length)
  (double, _par_within)
  (double, _length)
)
using width_convex_vairant = boost::variant<idb::cutlayer_property::lef58_enclosureedge_width,idb::cutlayer_property::lef58_enclosureedge_convexcorners>;
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_enclosureedge,
  (std::string, _classname)
  (std::string, _direction)
  (double, _overhang)
  (width_convex_vairant, _width_convex)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_eolenclosure_edgeoverhang,
  (std::string, _applied_to)
  (double, _overhang)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_eolenclosure_overhang,
  (double, _overhang)
  (std::optional<double>, _extract_overhang)
  (std::optional<double>, _par_space)
  (std::optional<double>, _backward_ext)
...
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_eolenclosure,
  (double, _eol_width)
  (std::optional<double>, _min_eol_width)
  (std::string, _edge_direction)
  (std::string, _equalrectwidth)
  (std::string, _classname)
  (std::string, _direction)
  (enclosure_variant, _overhang)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_eolspacing_toclass,
  (std::string, _classname)
  (double, _cut_spacing1)
  (double, _cut_spacing2)
)
...
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_spacingtable_layer,
  (std::string, _second_layername)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_spacingtable_prl,
  (double, _prl)
  (std::string, _direction)
  (std::string, _maxxy)
)
...
BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_spacingtable_cutspacing,
  (std::optional<double>, _cut1)
  (std::optional<double>, _cut2)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_spacingtable_cutspacings,
  (idb::cutlayer_property::lef58_spacingtable_classname, _classname2)
  (std::vector<idb::cutlayer_property::lef58_spacingtable_cutspacing>, _cutspacings)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_spacingtable_cutclass,
  (std::vector<idb::cutlayer_property::lef58_spacingtable_classname>, _classname1)
  (std::vector<idb::cutlayer_property::lef58_spacingtable_cutspacings>, _cuts)
)

BOOST_FUSION_ADAPT_STRUCT(
  idb::cutlayer_property::lef58_spacingtable,
  (std::optional<idb::cutlayer_property::lef58_spacingtable_layer>, _layer)
  (std::optional<idb::cutlayer_property::lef58_spacingtable_prl>, _prl)
  (idb::cutlayer_property::lef58_spacingtable_cutclass, _cutclass)
)
