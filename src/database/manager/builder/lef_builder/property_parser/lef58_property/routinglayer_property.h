...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::double_pair, 
    (double, first)
    (double, second)
)
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_area_exceptedgelength,
    (double, _min_edge_length)
    (std::optional<double>, _max_edge_length)
)

BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_area,
    (double, _min_area)
    (std::optional<int>, _mask_num)
    (std::optional<double>, _except_min_width)
    (std::optional<idb::routinglayer_property::lef58_area_exceptedgelength>, _exceptedgelength)
    (std::vector<idb::routinglayer_property::double_pair>, _except_min_size)
    (std::optional<idb::routinglayer_property::double_pair>, _except_step)
    (std::optional<double>, _rect_width)
    (std::string, _exceptrectangle)
    (std::string, _trim_layer)
    (std::optional<int>, _overlap)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_cornerfillspacing,
    (double, _spacing)
    (double, _length1)
    (double, _length2)
    (double, _eol_width)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::name_cuts,
    (std::string, _class_name)
    (int, _num_cuts)
)
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_minimumcut,
    (std::optional<int>, _num_cuts)
    (std::vector<idb::routinglayer_property::name_cuts>, _cuts)
    (double, _width)
    (std::optional<double>, _cut_distance)
    (std::string, _direction)
    (std::optional<double>, _length) 
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_notchlength,
    (double, _min_spacing)
    (double, _min_notch_length)
    (std::optional<double>, _low_exclude_spacing)
    (std::optional<double>, _high_exclude_spacing)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_eol_withcut,
    (std::string, _cutclass)
    (std::string, _above)
    (double, _with_cut_space)
    (std::optional<double>, _enclosure_end_width)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_eol_endprlspacing,
    (double, _end_prl_space)
    (double, _end_prl)
)

BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_eol_endtoend,
    (double, _end_to_end_space)
    (std::optional<double>, _one_cut_space)
    (std::optional<double>, _two_cut_space)
    (std::optional<double>, _extension)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_eol_paralleledge,
    (std::string, _subtract_eol_width)
    (double, _par_space)
    (double, _par_within)
    (std::optional<double>, _prl)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_eol_enclosecut,
    (std::string, _direction)
    (double, _enclose_dist)
    (double, _cut_to_metal_space)
    (std::string, _all_cuts)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacing_eol_toconcavecorner,
    (std::optional<double>,  _min_length)
    (std::optional<double>, _min_adj_length1)
    (std::optional<double>, _min_adj_length2)
)
...
BOOST_FUSION_ADAPT_STRUCT(
    ...
    (std::optional<double>, _wrong_dir_within)
    (std::string, _same_mask)
    (std::optional<idb::routinglayer_property::double_pair>, _except_exact_width)
    (std::optional<double>, _fill_triangle)
    (std::optional<idb::routinglayer_property::lef58_spacing_eol_withcut>, _withcut)
    (std::optional<idb::routinglayer_property::lef58_spacing_eol_endprlspacing>, _end_prl_spacing)
    (std::optional<idb::routinglayer_property::lef58_spacing_eol_endtoend>, _end_to_end)
    ...
    (std::string, _equal_rect_width)
    (std::optional<idb::routinglayer_property::lef58_spacing_eol_paralleledge>, _parallel_edge)
    (std::optional<idb::routinglayer_property::lef58_spacing_eol_enclosecut>, _enclose_cut)
    (std::optional<idb::routinglayer_property::lef58_spacing_eol_toconcavecorner>, _toconcavecorner)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacingtable_jogtojog_width,
    (double, _width)
    (double, _par_length)
    (double, _par_within)
    (std::optional<double>, _low_exclude_spacing)
...
BOOST_FUSION_ADAPT_STRUCT(
    idb::routinglayer_property::lef58_spacingtable_jogtojog,
    (double, _jog2jog_spacing)
    (double, _jog_width)
    (double, _short_jog_spacing)
