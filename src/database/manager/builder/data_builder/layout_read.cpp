...
namespace idb {
  LayoutRead::LayoutRead() { _layout = new IdbLayout(); }
  ...
  IdbUnits* LayoutRead::load_units() {
    ...
    shared_ptr<IdbUnitsHeader> header =
        make_shared<IdbUnitsHeader>(IdbFileHeaderType::kUnits, file_path.c_str(), _layout->get_units());
  ...
  IdbDie* LayoutRead::load_die() {
    ...
    shared_ptr<IdbDieHeader> header =
        make_shared<IdbDieHeader>(IdbFileHeaderType::kDie, file_path.c_str(), _layout->get_die());
  ...
  IdbLayers* LayoutRead::load_layers() {
    ...
    shared_ptr<IdbLayersHeader> header =
        make_shared<IdbLayersHeader>(IdbFileHeaderType::kLayers, file_path.c_str(), _layout->get_layers());
  ...
  IdbCore* LayoutRead::load_core() {
    ...
    shared_ptr<IdbCoreHeader> header =
        make_shared<IdbCoreHeader>(IdbFileHeaderType::kCore, file_path.c_str(), _layout->get_core());
  ...
  IdbSites* LayoutRead::load_sites() {
    ...
    shared_ptr<IdbSitesHeader> header =
        make_shared<IdbSitesHeader>(IdbFileHeaderType::kSites, file_path.c_str(), _layout->get_sites());
  ...
  IdbGCellGridList* LayoutRead::load_gcell_grid_list() {
    ...
    shared_ptr<IdbGcellGridHeader> header = make_shared<IdbGcellGridHeader>(
        IdbFileHeaderType::kGCellGridList, file_path.c_str(), _layout->get_gcell_grid_list());
  ...
  IdbTrackGridList* LayoutRead::load_track_grid_list() {
    ...
    shared_ptr<IdbTrackGridHeader> header = make_shared<IdbTrackGridHeader>(
        IdbFileHeaderType::kTrackGridList, file_path.c_str(), _layout->get_track_grid_list(), _layout->get_layers());
  ...
  IdbCellMasterList* LayoutRead::load_cell_master_list() {
    ...
    shared_ptr<IdbCellMasterHeader> header = make_shared<IdbCellMasterHeader>(
        IdbFileHeaderType::kCellMasterList, file_path.c_str(), _layout->get_cell_master_list(), _layout->get_layers());
  ...
  IdbVias* LayoutRead::load_via_list() {
    ...
    shared_ptr<IdbViaListHeader> header = make_shared<IdbViaListHeader>(IdbFileHeaderType::kVias, file_path.c_str(),
                                                                        _layout->get_via_list(), _layout->get_layers());
  ...
  IdbViaRuleList* LayoutRead::load_via_rule_list() {
    ...
    shared_ptr<IdbViaRuleListHeader> header = make_shared<IdbViaRuleListHeader>(
        IdbFileHeaderType::kViaRuleList, file_path.c_str(), _layout->get_via_rule_list(), _layout->get_layers());
