...
int defrData::sublex(YYSTYPE* pYylval)
{
  ...
  if (dumb_mode >= 0) {
    ...
    if (by_is_keyword && ((strcmp(deftoken, "BY") == 0) || (strcmp(deftoken, "by") == 0))) {
      return K_BY; /* even in dumb mode, we must see the BY deftoken */
    }
    if (do_is_keyword && ((strcmp(deftoken, "DO") == 0) || (strcmp(deftoken, "do") == 0))) {
      return K_DO; /* even in dumb mode, we must see the DO deftoken */
    }
    if (new_is_keyword && ((strcmp(deftoken, "NEW") == 0) || (strcmp(deftoken, "new") == 0))) {
      return K_NEW; /* even in dumb mode, we must see the NEW deftoken */
    }
    if (nondef_is_keyword && ((strcmp(deftoken, "NONDEFAULTRULE") == 0) || (strcmp(deftoken, "nondefaultrule") == 0))) {
      return K_NONDEFAULTRULE; /* even in dumb mode, we must see the */
                               /* NONDEFAULTRULE deftoken */
    }
    if (mustjoin_is_keyword && ((strcmp(deftoken, "MUSTJOIN") == 0) || (strcmp(deftoken, "mustjoin") == 0))) {
      return K_MUSTJOIN; /* even in dumb mode, we must see the */
                         /* MUSTJOIN deftoken */
    }
    if (step_is_keyword && ((strcmp(deftoken, "STEP") == 0) || (strcmp(deftoken, "step") == 0))) {
      return K_STEP; /* even in dumb mode, we must see the STEP deftoken */
    }
    if (fixed_is_keyword && ((strcmp(deftoken, "FIXED") == 0) || (strcmp(deftoken, "fixed") == 0))) {
      return K_FIXED; /* even in dumb mode, we must see the FIXED deftoken */
    }
    if (cover_is_keyword && ((strcmp(deftoken, "COVER") == 0) || (strcmp(deftoken, "cover") == 0))) {
      return K_COVER; /* even in dumb mode, we must see the COVER deftoken */
    }
    if (routed_is_keyword && ((strcmp(deftoken, "ROUTED") == 0) || (strcmp(deftoken, "routed") == 0))) {
      return K_ROUTED; /* even in dumb mode, we must see the */
                       /* ROUTED deftoken */
    }

    if (virtual_is_keyword && ((strcmp(deftoken, "VIRTUAL") == 0) || (strcmp(deftoken, "virtual") == 0))) {
      return K_VIRTUAL;
    }

    if (rect_is_keyword && ((strcmp(deftoken, "RECT") == 0) || (strcmp(deftoken, "rect") == 0))) {
      return K_RECT;
    }

    if (virtual_is_keyword && ((strcmp(deftoken, "MASK") == 0) || (strcmp(deftoken, "mask") == 0))) {
      return K_MASK;
    }
...
void defrData::defyyerror(const char* s)
{
...
const char* defrData::defkywd(int num)
{
  switch (num) {
    ...
    case K_CAPACITANCE:
      return "CAPACITANCE";
    case K_COMMONSCANPINS:
      return "COMMONSCANPINS";
    case K_COMPONENT:
      return "COMPONENT";
    case K_COMPONENTPIN:
      return "COMPONENTPIN";
    ...
    case K_DESIGN:
      return "DESIGN";
    case K_DESIGNRULEWIDTH:
      return "DESIGNRULEWIDTH";
    case K_DIAGWIDTH:
      return "DIAGWIDTH";
    case K_DIEAREA:
      return "DIEAREA";
    ...
    case K_GROUND:
      return "GROUND";
    case K_GROUNDSENSITIVITY:
      return "GROUNDSENSITIVITY";
    case K_GROUP:
      return "GROUP";
    case K_GROUPS:
      return "GROUPS";
    ...
    case K_MAXDIST:
      return "MAXDIST";
    case K_MAXHALFPERIMETER:
      return "MAXHALFPERIMETER";
    case K_MAXX:
      return "MAXX";
    case K_MAXY:
      return "MAXY";
    ...
    case K_RECT:
      return "RECT";
    case K_REENTRANTPATHS:
      return "REREENTRANTPATHS";
    case K_REGION:
      return "REGION";
    case K_REGIONS:
      return "REGIONS";
    ...
    case K_SUM:
      return "SUM";
    case K_SUPPLYSENSITIVITY:
      return "SUPPLYSENSITIVITY";
    case K_STYLE:
      return "STYLE";
    case K_STYLES:
      return "STYLES";
    ...
    case K_TIMING:
      return "TIMING";
    case K_TIMINGDISABLES:
      return "TIMINGDISABLES";
    case K_TOCLOCKPIN:
      return "TOCLOCKPIN";
    case K_TOCOMPPIN:
      return "TOCOMPPIN";
...
const char* defrData::DEFCASE(const char* ch)
{
