...
const char* defrSettings::defOxides[]
    = {"OXIDE1",  "OXIDE2",  "OXIDE3",  "OXIDE4",  "OXIDE5",  "OXIDE6",  "OXIDE7",  "OXIDE8",  "OXIDE9",  "OXIDE10", "OXIDE11",
       "OXIDE12", "OXIDE13", "OXIDE14", "OXIDE15", "OXIDE16", "OXIDE17", "OXIDE18", "OXIDE19", "OXIDE20", "OXIDE21", "OXIDE22",
       "OXIDE23", "OXIDE24", "OXIDE25", "OXIDE26", "OXIDE27", "OXIDE28", "OXIDE29", "OXIDE30", "OXIDE31", "OXIDE32"};
...
defrSession::defrSession() : reader_case_sensitive(0), FileName(0), UserData(NULL)
{
}
