...
//       if ((-1.0, -1.0) != (conn_rust.coordinates[0], conn_rust.coordinates[1])) {
...
//       if ((-1.0, -1.0) != (conn_rust.ll_coordinate[0], conn_rust.ll_coordinate[1])) {
...
//       if ((-1.0, -1.0) != (conn_rust.ur_coordinate[0], conn_rust.ur_coordinate[1])) {
//         ur_coordinate = {conn_rust.ur_coordinate[0], conn_rust.ur_coordinate[1]};
//       }
...
//           = std::make_tuple(std::string(cap_rust.pin_port[0]), std::string(cap_rust.pin_port[1]), cap_rust.cap_val);
//       caps.push_back(cap);
//     }
...
//           = std::make_tuple(std::string(res_rust.pin_port[0]), std::string(res_rust.pin_port[1]), res_rust.res);
//       ress.push_back(res);
//     }
