...
//   core_logic["Area Ratio"] = ((double) _design->get_instance_list()->get_area_core_logic()) /
//   dmInst->instanceArea(IdbInstanceType::kMax); summary_instance["Core - logic"] = core_logic; json pad; pad["Number"] =
//   _design->get_instance_list()->get_num_pad(); pad["Number Ratio"] = ((double) _design->get_instance_list()->get_num_pad()) /
//   _design->get_instance_list()->get_num(); pad["Area"] = _design->get_instance_list()->get_area_pad(); pad["Area Ratio"] = ((double)
//   _design->get_instance_list()->get_area_pad()) / dmInst->instanceArea(IdbInstanceType::kMax); summary_instance["Pad"] = pad; json block;
