...
do
    ...
    then
        ...
        then
            ...
            cat ../settings/ug_scip_stp.set > results/ug_scip_stp.set
            ...
            echo -----------------------------
            date +"@03 %s"
            echo -e "ulimit -t $HARDTIMELIMIT s;../$BINNAME $TMPFILE $i -ntpr 2 -ntprr 2 -sth $THREADS"
            bash -c "ulimit -t $HARDTIMELIMIT s;../$BINNAME $TMPFILE $i -ntpr 2 -ntprr 2 -sth $THREADS" 2>>$ERRFILE
