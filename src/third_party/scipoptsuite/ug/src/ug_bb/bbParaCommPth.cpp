...
bool
BbParaCommPth::tagStringTableIsSetUpCoorectly(
      )
{
   if( !UG::ParaCommPth::tagStringTableIsSetUpCoorectly() ) return false;
      ...
      )
{
   ...
   {
      return ParaCommPth::getTagString(tag);
   }
   else
   {
...
BbParaCommPth::createParaCalculationState(
      )
{
...
ParaSolverState *
BbParaCommPth::createParaSolverState(
      )
{
...
BbParaCommPth::createParaSolverTerminationState(
      )
{
