...
lefiPin::addAntennaModel(int oxide)
{
    ...
    if (numAntennaModel_ == 0) {   // does not have antennaModel
        pinAntennaModel_ = (lefiPinAntennaModel**)
            lefMalloc(sizeof(lefiPinAntennaModel*) * lefMaxOxides);
                              ...
                              const char    *layer)
{
    if (numAntennaModel_ == 0)    // haven't created any antennaModel yet
        addAntennaModel(1);
    pinAntennaModel_[curAntennaModelIndex_]->addAntennaMaxAreaCar(val,
                                                               layer);
}
                                  ...
                                  const char    *layer)
{
    if (numAntennaModel_ == 0)    // haven't created any antennaModel yet
        addAntennaModel(1);
    pinAntennaModel_[curAntennaModelIndex_]->addAntennaMaxSideAreaCar(val,
                                                                   layer);
}
                             ...
                             const char *layer)
{
    if (numAntennaModel_ == 0)    // haven't created any antennaModel yet
        addAntennaModel(1);
    pinAntennaModel_[curAntennaModelIndex_]->addAntennaMaxCutCar(val,
                                                              layer);
}
