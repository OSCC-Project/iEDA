...
std::vector<double> ModelFactory::solvePolynomialRealRoots(
...
std::vector<double> ModelFactory::cppLinearModel(
...
ModelBase* ModelFactory::pyFit(const std::vector<std::vector<double>>& x,
