...
/**
 * check jog conditions
 *
 */

class DrcRuleConditionJog : public DrcRuleConditionMatrix
{
 public:
  DrcRuleConditionJog(DrcConditionManager* condition_manager, DrcEngine* engine)
      : DrcRuleConditionMatrix(condition_manager, engine, RuleType::kSpacingJogToJog)
  {
  }
  ~DrcRuleConditionJog() {}
