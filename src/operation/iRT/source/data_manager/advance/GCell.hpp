...
class GCell
{
 public:
  ...
  std::map<int32_t, std::map<Orientation, int32_t>>& get_routing_orien_supply_map() { return _routing_orien_supply_map; }
  std::map<int32_t, std::set<Segment<LayerCoord>*>>& get_net_result_map() { return _net_result_map; }
  ...
  void set_routing_orien_supply_map(const std::map<int32_t, std::map<Orientation, int32_t>>& routing_orien_supply_map)
  {
    _routing_orien_supply_map = routing_orien_supply_map;
  }
  void set_net_result_map(const std::map<int32_t, std::set<Segment<LayerCoord>*>>& net_result_map) { _net_result_map = net_result_map; }
 ...
 private:
  ...
  std::map<int32_t, std::map<Orientation, int32_t>> _routing_orien_supply_map;
  // routing result
  std::map<int32_t, std::set<Segment<LayerCoord>*>> _net_result_map;
