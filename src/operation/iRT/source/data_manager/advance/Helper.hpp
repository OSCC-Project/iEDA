...
class Helper
{
 public:
  ...
  std::map<irt_int, irt_int>& get_routing_idb_layer_id_to_idx_map() { return _routing_idb_layer_id_to_idx_map; }
  std::map<irt_int, irt_int>& get_cut_idb_layer_id_to_idx_map() { return _cut_idb_layer_id_to_idx_map; }
  ...
  // function
  inline irt_int getRoutingLayerIdxByIDBLayerId(const irt_int idb_layer_id);
  inline irt_int getCutLayerIdxByIDBLayerId(const irt_int idb_layer_id);
 ...
 private:
  ...
  std::map<irt_int, irt_int> _routing_idb_layer_id_to_idx_map;
  std::map<irt_int, irt_int> _cut_idb_layer_id_to_idx_map;
...
inline irt_int Helper::getRoutingLayerIdxByIDBLayerId(const irt_int idb_layer_id)
{
...
inline irt_int Helper::getCutLayerIdxByIDBLayerId(const irt_int idb_layer_id)
{
