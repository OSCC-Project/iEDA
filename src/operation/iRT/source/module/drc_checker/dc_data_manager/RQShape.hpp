...
class RQShape
{
 public:
  ...
  BGBox& get_enlarged_shape() { return _enlarged_shape; }
  // setters
  void set_net_id(const irt_int net_id) { _net_id = net_id; }
  void set_shape(const BGBox& shape) { _shape = shape; }
  ...
  void set_enlarged_shape(const BGBox& enlarged_shape) { _enlarged_shape = enlarged_shape; }
  // function
