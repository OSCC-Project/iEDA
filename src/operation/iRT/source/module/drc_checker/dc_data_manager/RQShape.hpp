...
class RQShape
{
 public:
  ...
  BGRectInt& get_enlarged_shape() { return _enlarged_shape; }
  // setters
  ...
  void set_enlarged_shape(const BGRectInt& enlarged_shape) { _enlarged_shape = enlarged_shape; }
  // function
