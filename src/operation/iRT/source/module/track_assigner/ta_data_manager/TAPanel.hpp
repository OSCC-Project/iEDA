...
class TAPanel
{
 public:
  ...
  std::map<int32_t, std::map<int32_t, std::vector<LayerRect>>>& get_net_pin_access_patch_map() { return _net_pin_access_patch_map; }
  ...
  void set_net_pin_access_patch_map(const std::map<int32_t, std::map<int32_t, std::vector<LayerRect>>>& net_pin_access_patch_map)
  {
 ...
 private:
  ...
  std::map<int32_t, std::map<int32_t, std::vector<LayerRect>>> _net_pin_access_patch_map;
