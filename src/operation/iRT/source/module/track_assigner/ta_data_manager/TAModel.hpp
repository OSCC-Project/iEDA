...
class TAModel
{
 public:
  ...
  std::vector<std::vector<TASchedule>>& get_ta_schedule_comb_list() { return _ta_schedule_comb_list; }
  ...
  void set_ta_schedule_comb_list(const std::vector<std::vector<TASchedule>>& ta_schedule_comb_list)
  {
    _ta_schedule_comb_list = ta_schedule_comb_list;
  }
 ...
 private:
  ...
  std::vector<std::vector<TASchedule>> _ta_schedule_comb_list;
