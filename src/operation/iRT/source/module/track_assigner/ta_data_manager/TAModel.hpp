...
class TAModel
{
 public:
  ...
  std::vector<std::vector<TAPanelId>>& get_ta_panel_id_comb_list() { return _ta_panel_id_comb_list; }
  ...
  void set_ta_panel_id_comb_list(const std::vector<std::vector<TAPanelId>>& ta_panel_id_comb_list)
  {
    _ta_panel_id_comb_list = ta_panel_id_comb_list;
  }
