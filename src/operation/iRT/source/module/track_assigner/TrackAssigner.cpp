...
void TrackAssigner::countTAPanel(TAModel& ta_model, TAPanel& ta_panel)
{
  ...
  for (TASourceType ta_source_type : {TASourceType::kLayoutShape}) {
    for (auto& [drc, violation_info_list] : getValidViolationInfo(ta_panel, ta_source_type)) {
...
bool TrackAssigner::hasValidViolation(TAPanel& ta_panel, TASourceType ta_source_type, const std::vector<DRCRect>& drc_rect_list)
{
  return !(getValidViolationInfo(ta_panel, ta_source_type, drc_rect_list).empty());
}

std::map<std::string, std::vector<ViolationInfo>> TrackAssigner::getValidViolationInfo(TAPanel& ta_panel, TASourceType ta_source_type,
...
bool TrackAssigner::hasValidViolation(TAPanel& ta_panel, TASourceType ta_source_type)
{
  return !(getValidViolationInfo(ta_panel, ta_source_type).empty());
}
