...
class VRNet
{
 public:
  ...
  MTree<GuideSegNode>& get_dr_result_tree() { return _dr_result_tree; }
  ...
  void set_dr_result_tree(const MTree<GuideSegNode>& dr_result_tree) { _dr_result_tree = dr_result_tree; }
 ...
 private:
  ...
  MTree<GuideSegNode> _dr_result_tree;
