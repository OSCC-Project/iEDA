...
class PABox
{
 public:
  ...
  std::map<int32_t, std::map<int32_t, std::vector<Segment<LayerCoord>>>>& get_net_task_access_result_map()
  {
    return _net_task_access_result_map;
  }
  ...
  std::map<int32_t, std::map<int32_t, std::vector<Segment<LayerCoord>>>>& get_best_net_task_access_result_map()
  {
    return _best_net_task_access_result_map;
  }
  ...
  void set_net_task_access_result_map(
      const std::map<int32_t, std::map<int32_t, std::vector<Segment<LayerCoord>>>>& net_task_access_result_map)
  {
  ...
  void set_best_net_task_access_result_map(
      const std::map<int32_t, std::map<int32_t, std::vector<Segment<LayerCoord>>>>& best_net_task_access_result_map)
  {
