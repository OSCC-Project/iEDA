...
class GRModel
{
 public:
  ...
  std::vector<std::pair<std::vector<GRNode*>, std::vector<GRNode*>>>& get_node_topo_list() { return _node_topo_list; }
  ...
  void set_node_topo_list(const std::vector<std::pair<std::vector<GRNode*>, std::vector<GRNode*>>>& node_topo_list)
  {
    _node_topo_list = node_topo_list;
  }
  ...
  std::vector<GRNode*>& get_end_node_list() { return _end_node_list; }
  ...
  irt_int get_end_node_idx() const { return _end_node_idx; }
  void set_start_node_list(const std::vector<GRNode*>& start_node_list) { _start_node_list = start_node_list; }
  void set_end_node_list(const std::vector<GRNode*>& end_node_list) { _end_node_list = end_node_list; }
  ...
  void set_end_node_idx(const irt_int end_node_idx) { _end_node_idx = end_node_idx; }
#endif
 ...
 private:
  ...
  std::vector<std::pair<std::vector<GRNode*>, std::vector<GRNode*>>> _node_topo_list;
  std::vector<Segment<GRNode*>> _node_segment_list;
  // single path
  std::vector<GRNode*> _start_node_list;
  std::vector<GRNode*> _end_node_list;
