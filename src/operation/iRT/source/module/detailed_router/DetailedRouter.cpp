...
void DetailedRouter::outputNetJson(DRModel& dr_model)
{
  ...
  std::ofstream* net_json_file = RTUTIL.getOutputFileStream(RTUTIL.getString(dr_temp_directory_path, "net_map_", dr_model.get_iter(), ".json"));
...
void DetailedRouter::outputViolationJson(DRModel& dr_model)
{
  ...
  std::ofstream* violation_json_file = RTUTIL.getOutputFileStream(RTUTIL.getString(dr_temp_directory_path, "violation_map_", dr_model.get_iter(), ".json"));
