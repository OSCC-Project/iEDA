...
class DRModelStat
{
 public:
  ...
  std::map<irt_int, std::set<PlanarRect, CmpPlanarRectByXASC>>& get_routing_net_and_fence_rect_map()
  {
    return _routing_net_and_fence_rect_map;
  }
  ...
  irt_int get_total_net_and_fence_rect_number() { return _total_net_and_fence_rect_number; }
  ...
  void set_total_net_and_fence_rect_number(const irt_int total_net_and_fence_rect_number)
  {
    _total_net_and_fence_rect_number = total_net_and_fence_rect_number;
  }
 ...
 private:
  ...
  std::map<irt_int, std::set<PlanarRect, CmpPlanarRectByXASC>> _routing_net_and_fence_rect_map;
  ...
  irt_int _total_net_and_fence_rect_number = 0;
