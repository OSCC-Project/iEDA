...
class DRModel
{
 public:
  ...
  std::vector<std::vector<DRSchedule>>& get_dr_schedule_comb_list() { return _dr_schedule_comb_list; }
  ...
  void set_dr_schedule_comb_list(const std::vector<std::vector<DRSchedule>>& dr_schedule_comb_list)
  {
    _dr_schedule_comb_list = dr_schedule_comb_list;
  }
 ...
 private:
  ...
  std::vector<std::vector<DRSchedule>> _dr_schedule_comb_list;
