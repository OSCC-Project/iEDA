...
int main()
{
...

  {
    ...
    std::vector<PlanarRect> cutting_result_list = RTUtil::getOpenCuttingRectListByBoost(master_list, rect_list);
    RTUtil::plotGDS("cutting_result_list", cutting_result_list);
  }
