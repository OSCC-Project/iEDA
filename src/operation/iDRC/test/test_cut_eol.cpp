...
int main(int argc, char* argv[])
{
  ...
  DrcRect* rect1 = DrcAPIInst.getDrcRect(1, 1750, 800, 1850, 900, "VIA6");
  DrcRect* rect2 = DrcAPIInst.getDrcRect(1, 1850, 1000, 1950, 1100, "VIA6");
  // DrcRect* rect2 = DrcAPIInst.getDrcRect(7, RectOwnerType::kViaCut, 200, 200, 300, 300, "VIA7");
  DrcRect* rect3 = DrcAPIInst.getDrcRect(1, 1000, 1000, 2000, 1100, "M7");
  DrcRect* rect4 = DrcAPIInst.getDrcRect(1, 1000, 800, 2000, 900, "M7");

  std::vector<DrcRect*> origin_rect_list{rect1, rect2, rect3};
