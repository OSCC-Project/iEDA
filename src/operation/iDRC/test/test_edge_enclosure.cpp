...
int main(int argc, char* argv[])
{
  ...
  DrcRect* rect1 = DrcAPIInst.getDrcRect(1, 1850, 1000, 2110, 1100, "M7");
  DrcRect* rect2 = DrcAPIInst.getDrcRect(1, 2010, 100, 2110, 1100, "M7");
  DrcRect* rect3 = DrcAPIInst.getDrcRect(1, 2210, 100, 2310, 1100, "M7");

  DrcRect* rect4 = DrcAPIInst.getDrcRect(1, 1000, 1000, 3000, 1100, "M6");

  //   DrcRect* rect2 = DrcAPIInst.getDrcRect(1, 1000, 1000, 2010, 1100, "M6");

  DrcRect* rect5 = DrcAPIInst.getDrcRect(1, 1950, 1000, 2050, 1100, "VIA6");
  ...
  std::vector<DrcRect*> origin_rect_list{rect1, rect2, rect3, rect4, rect5};
