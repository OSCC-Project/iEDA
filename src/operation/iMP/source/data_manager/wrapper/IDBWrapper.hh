 ...
 * @Description:
 * @FilePath: /iEDA/src/imp/src/wrapper/IDBWrapper.hh
...
class IDBWrapper : public DBWrapper
{
 public:
  ...
  explicit IDBWrapper(const std::string& idb_json);
  ...
  void setIdbBuilder(IdbBuilder* idb_builder);
 ...
 private:
  IDBWrapper() : _idbw_database(new IDBWDatabase()) {}
