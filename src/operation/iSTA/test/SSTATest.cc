...
TEST_F(SSTATest, test) {
  ...
  std::vector<const char*> lib_files{
      ...
      "NangateOpenCellLibrary_typical.lib"};  // 45552
  ...
  double ret_val = find_value_test(lib_data_gpu, 0.00472397, 1.897810);
