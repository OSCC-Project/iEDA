...
idb::IdbSpecialWireSegment* PowerVia::createSpecialWireVia(idb::IdbLayer* layer, int32_t route_width, idb::IdbWireShapeType wire_shape_type,
...
bool PowerVia::getIntersectCoordinate(idb::IdbSpecialWireSegment* segment_top, idb::IdbSpecialWireSegment* segment_bottom,
                            ...
                            int32_t height)
{
  ...
  // Find all cut layers
  std::vector<idb::IdbLayerCut*> cut_layer_list = idb_layer_list->find_cut_layer_list(top_layer, bottom_layer);
  ...
  for (auto layer_cut : cut_layer_list) {
    ...
    // Create via segment
    idb::IdbSpecialWireSegment* segment_via = createSpecialWireVia(via_top_layer, 0, idb::IdbWireShapeType::kStripe, coord, via);
...
void PowerVia::connect_M2_M1(std::string net_name)
{
  ...
  // Get layer information
  idb::IdbLayerRouting* layer_M3 = dynamic_cast<idb::IdbLayerRouting*>(idb_layer_list->find_layer("M3"));
  idb::IdbLayerRouting* layer_M2 = dynamic_cast<idb::IdbLayerRouting*>(idb_layer_list->find_layer("M2"));
  idb::IdbLayerRouting* layer_M1 = dynamic_cast<idb::IdbLayerRouting*>(idb_layer_list->find_layer("M1"));
  idb::IdbLayerCut* layer_via1 = dynamic_cast<idb::IdbLayerCut*>(idb_layer_list->find_layer("VIA1"));
  idb::IdbLayerCut* layer_via2 = dynamic_cast<idb::IdbLayerCut*>(idb_layer_list->find_layer("VIA2"));
