...
class LmShapeTableView : public QTableView
{
  Q_OBJECT

 public:
  LmShapeTableView(QWidget* parent = nullptr) : QTableView(parent)
  {
...
class LmColorItemDelegate : public QStyledItemDelegate
{
  Q_OBJECT
 public:
...
class LmGraphWidget : public QOpenGLWidget, protected QOpenGLFunctions
{
  Q_OBJECT
 public:
  enum ShapeType
 ...
 public:
  explicit LmGraphWidget(QWidget* parent = nullptr);
  ~LmGraphWidget() override {}
