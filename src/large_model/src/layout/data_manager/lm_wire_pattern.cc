...
#include "log/Log.hh"
namespace ilm {
void LmWirePatternGenerator::genPatterns()
{
  auto gen = LmNetGraphGenerator();
...
void LmWirePatternGenerator::addPattern(LmNetWire& wire)
{
...
void LmWirePatternGenerator::patternSummary(const std::string& csv_path)
{
...
std::vector<Point> LmWirePatternGenerator::getPointList(LmNetWire& wire)
{
...
LmWirePatternSequence LmWirePatternGenerator::calcPattern(const std::vector<Point>& points)
{
