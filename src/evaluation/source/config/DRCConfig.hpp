#ifndef SRC_EVALUATOR_SOURCE_WRAPPER_CONFIG_DRCCONFIG_HPP_
#define SRC_EVALUATOR_SOURCE_WRAPPER_CONFIG_DRCCONFIG_HPP_
...
#endif  // SRC_EVALUATOR_SOURCE_WRAPPER_CONFIG_DRCCONFIG_HPP_
