...
class ContestSegment
{
 public:
  ...
  auto getSegmentLength(int single_gcell_x_span, int single_gcell_y_span)
  {
    return _first.get_x() == _second.get_x() ? (_second.get_y() - _first.get_y()) * single_gcell_y_span
                                             : (_second.get_x() - _first.get_x()) * single_gcell_x_span;
  }
