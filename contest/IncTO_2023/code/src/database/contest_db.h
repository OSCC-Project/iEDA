...
class ContestDB
{
 public:
  ...
  std::map<int, std::string>& get_layer_idx_to_name_map() { return _layer_idx_to_name_map; }
  std::map<int, idb::IdbLayerDirection>& get_layer_idx_to_direction_map() { return _layer_idx_to_direction_map; }
 ...
 private:
  ...
  std::map<int, std::string> _layer_idx_to_name_map;
