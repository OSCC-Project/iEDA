...
class ContestCoord
{
 public:
  ...
  bool operator<(const ContestCoord& rhs) const { return _x < rhs._x || (_x == rhs._x && _y < rhs._y); }

  ContestCoord operator-(const ContestCoord& other) const
  {
    return ContestCoord(_x - other._x, _y - other._y, _layer_idx - other._layer_idx);
  }
  // getter
