...
os.system('./iEDA_gui -script ./script/iGUI_script/run_iGUI_fp.tcl')
...
os.system('./iEDA_gui -script ./script/iGUI_script/run_iGUI_pl.tcl')
...
os.system('./iEDA_gui -script ./script/iGUI_script/run_iGUI_rt.tcl')
...
os.system('./iEDA_gui -script ./script/iGUI_script/run_iGUI_drc.tcl')
...
os.system('./iEDA_gui -script ./script/iGUI_script/run_iGUI_filler.tcl')
