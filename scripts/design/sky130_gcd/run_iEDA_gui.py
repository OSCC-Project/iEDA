...
def main():
    ...
    execute_shell_command('./iEDA_gui -script ./script/iGUI_script/run_iGUI_fp.tcl')
    ...
    execute_shell_command('./iEDA_gui -script ./script/iGUI_script/run_iGUI_pl.tcl')
    ...
    execute_shell_command('./iEDA_gui -script ./script/iGUI_script/run_iGUI_rt.tcl')
    ...
    execute_shell_command('./iEDA_gui -script ./script/iGUI_script/run_iGUI_drc.tcl')
    ...
    execute_shell_command('./iEDA_gui -script ./script/iGUI_script/run_iGUI_filler.tcl')
